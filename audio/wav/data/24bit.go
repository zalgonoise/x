...
func (d *Chunk24bit) Generate(waveType osc.Type, freq, sampleRate int, dur time.Duration) {
...
func formFunc24and32bit(typ osc.Type) osc.Oscillator[int32] {
	switch typ {
	case osc.SineWave:
		return osc.Sine[int32]
	case osc.SquareWave:
