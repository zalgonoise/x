...
require (
	...
	github.com/zalgonoise/x/cli v0.0.0-20250626210019-e9aeebe8e7e5
	github.com/zalgonoise/x/errs v0.0.0-20250626210019-e9aeebe8e7e5
	github.com/zalgonoise/x/ptr v0.0.0-20250626210019-e9aeebe8e7e5
