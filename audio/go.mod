...
require (
	...
	github.com/zalgonoise/x/cli v0.0.0-20240724170009-72566912a5a1
	github.com/zalgonoise/x/errs v0.0.0-20240724170009-72566912a5a1
	github.com/zalgonoise/x/ptr v0.0.0-20240724170009-72566912a5a1
