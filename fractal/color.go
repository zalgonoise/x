...
func colorMap(n int) color.Color {
	fraction := float64(n) / maxIter
	r := uint8(float64(0) + (float64(255)-float64(0))*fraction)
	g := uint8(float64(0) + (float64(0)-float64(0))*fraction)
	b := uint8(float64(255) + (float64(125)-float64(255))*fraction)
