...
func NewCertificate(opts ...cfg.Option[Template]) (cert *pem.Block, err error) {
	t := cfg.Set(newDefaultTemplate(), opts...)
	...
	return &pem.Block{Type: typeCertificate, Bytes: data}, nil
}
