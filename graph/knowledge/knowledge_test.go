	...
	t.Run("StringID", func(t *testing.T) {
		t.Run("IntWeight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[string, int])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[string, int], got %T", g)
				}
			})
		...
		t.Run("Float64Weight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[string, float64])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[string, int], got %T", g)
				}
			})
	...
	t.Run("IntID", func(t *testing.T) {
		t.Run("IntWeight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[int, int])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[int, int], got %T", g)
				}
			})
			t.Run("SuccessWithNilValue", func(t *testing.T) {
		...
		t.Run("Float64Weight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[int, float64])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[int, int], got %T", g)
				}
			})
	...
	t.Run("FloatID", func(t *testing.T) {
		t.Run("IntWeight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[float32, int])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[float32, int], got %T", g)
				}
			})
			t.Run("SuccessWithNilValue", func(t *testing.T) {
		...
		t.Run("Float64Weight", func(t *testing.T) {
			t.Run("Success", func(t *testing.T) {
				...
				_, ok := g.(*knowledgeGraph[float32, float64])
				if !ok {
					t.Errorf("unexpected graph type -- wanted *knowledgeGraph[float32, int], got %T", g)
				}
			})
...
func TestConfig(t *testing.T) {
	t.Run("Default", func(t *testing.T) {
		wants := options.New(options.CfgKnowledgeGraph)
	...
	t.Run("WithConfig", func(t *testing.T) {
		wants := options.New(options.CfgKnowledgeGraph, options.ReadOnly)
...
func TestConnect(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		t.Run("ConnectAcrossGraphs", func(t *testing.T) {
			...
			if nodeC22.ID() != e[0].ID() {
				t.Errorf("output mismatch error: wanted %s ; got %s", nodeC22.ID(), e[0].ID())
			}

			w, err := subhubA1.Weight(nodeA11.ID(), nodeC22.ID())
			if err != nil {
				t.Errorf("unexpected error getting weight from node link %s to %s: %v", nodeA11.ID(), nodeC22.ID(), err)
			}
	...
	t.Run("Fail", func(t *testing.T) {
		...
		t.Run("ConnectingCrossGraphWhenUnsupported", func(t *testing.T) {
			...
			kG := New[string, int]("list", options.NoType, nil)
			kNode := New[string, int]("l-a", options.NoType, nil)
			...
			err = kG.Add(kNode)
			if err != nil {
				t.Errorf("unexpected error adding node %v to %v: %v", kNode.ID(), kG.ID(), err)
			}

			err = root.Add(kG, matrixG)
			if err != nil {
				t.Errorf("unexpected error adding nodes %v and %v to %v: %v", kG.ID(), matrixG.ID(), root.ID(), err)
			}

			err = kG.Connect(kNode.ID(), matrixNode.ID(), 1)
			if err == nil {
				t.Errorf("error expected when connecting nodes %v and %v: %v", kNode.ID(), matrixNode.ID(), err)
			}
			if !errors.Is(err, errs.DoesNotExist) {
